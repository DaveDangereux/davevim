...
vim.cmd([[
  augroup options
    autocmd!
    autocmd BufWritePost *nvim/lua/config/options.lua source <afile>
    autocmd BufWritePost *nvim/lua/config/options.lua lua require("config.bufferline").config()
    autocmd BufWritePost *nvim/lua/config/options.lua lua require("config.feline").config()
  augroup end
]])
